...
4. 顔追跡を停止し、位置や目元、透明度、大きさ、縁を調整します。
5. 画像を共有または保存します。
...
<img src="docs/image/ui.png" alt="操作画面の各機能" width="560px">
...
8. 加工なし・目線・モザイクから選択
9. 顔の透明度を調整
10. 顔の大きさを0.5倍から2.0倍まで拡縮（スマホでは顔の上のピンチ操作、キーボードでは `+` / `-` キーでも変更可能）
11. 顔の縁の馴染み具合を調整（マイナスで背景に馴染み、プラスで境目がくっきり）
