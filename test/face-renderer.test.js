...
test('ガラスの縁を顔サイズに合わせて細く保つ', () => {
    ...
    assert.equal(FaceRenderer.calculateGlassRim(400, 480).lineWidth, 5);
});
...
test('算出済みの顔領域を円形グラデーション付きで描画する', () => {
    ...
    assert.deepEqual(
        ...
        [
            ...
            ['color', 0, 'rgba(255, 255, 255, 0.46)'],
            ['color', 0.35, 'rgba(248, 251, 253, 0.28)'],
            ['color', 0.7, 'rgba(196, 208, 218, 0.24)'],
