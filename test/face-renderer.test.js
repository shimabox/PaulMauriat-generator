...
test('縁強度-1で描画すると白い膜と縁線のアルファが0になり、外周は透け感・膜開始位置は外側へ退避する', () => {
    ...
    // フェード中間stopのアルファは fadeAlphaScale(0.55) 倍に下がり、外周ゾーンの透け感が増す。
    assert.deepEqual(colorCalls[1], ['color', 0.62, 'rgba(0, 0, 0, 0.4853)']);
